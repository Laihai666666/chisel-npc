error id: 
file://<WORKSPACE>/npc/src/ysyx_23060351.scala
...
offset: 4150
uri: file://<WORKSPACE>/npc/src/ysyx_23060351.scala
text:
```scala
package npc
...
class ysyx_23060351 extends Module {
  ...
  val perf     = Module(new PerformanceCounter) // 性能计数器实例
  ...
  perf.io.finish    := wbu.io.in.bits.ctrlbreak&wbu.io.finsh 
...
object ysyx_23060351 extends App {
  ChiselStage.emitSystemVerilogFile(
    ...
    args = Array(
      "--target-dir",
      "<HOME>/ysyx/ysyx-workbench/npc/chisel/build",
      "--split-verilog",
      "--throw-on-first-error"
    ),
    firtoolOpts = Array("-disable-a@@ll-randomization", "-strip-debug-info")
  )
}
