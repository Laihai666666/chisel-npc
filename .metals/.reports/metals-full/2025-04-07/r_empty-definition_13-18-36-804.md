error id: config/Configs.OP_TYPES_WIDTH.
file://<WORKSPACE>/npc/src/IDU.scala
empty definition using pc, found symbol in pc: config/Configs.OP_TYPES_WIDTH.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/OP_TYPES_WIDTH.
	 -chisel3/util/OP_TYPES_WIDTH.
	 -config/Configs.OP_TYPES_WIDTH.
	 -utils/OP_TYPES.OP_TYPES_WIDTH.
	 -utils/OP_TYPES_WIDTH.
	 -OP_TYPES_WIDTH.
	 -scala/Predef.OP_TYPES_WIDTH.
offset: 2774
...
class IDU extends Module {
  ...
  val ctrlOP       = WireDefault(0.U(OP@@_TYPES_WIDTH.W))
