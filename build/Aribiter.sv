...
module Aribiter(
  ...
  output        io_axi_ifu_in_rlast,
  input         io_axi_ifu_out_arvalid,
  input  [31:0] io_axi_ifu_out_araddr,
  input  [2:0]  io_axi_ifu_out_arsize,
  input         io_axi_ifu_out_rready,
  ...
  Xbar xbar (
    ...
    .io_axi_in_rlast        (io_axi_ifu_in_rlast),
    ...
    .io_axi_out_arsize      (state ? io_axi_lsu_out_arsize : io_axi_ifu_out_arsize),
    .io_axi_out_rready      (state ? state : io_axi_ifu_out_rready),
    ...
    .io_soc_axi_in_rlast    (io_axi_soc_in_rlast),
